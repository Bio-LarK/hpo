...
require_once "OWLPropertyTag.php";
require_once "OWLClassTag.php";
require_once "OWLSubClassOfTag.php";
require_once "OWLDomainTag.php";
require_once "OWLRangeTag.php";
require_once "OWLInstanceTag.php";
require_once "OWLPropInstanceTag.php";
require_once "OWLLabelTag.php";
require_once "OWLIntersectionOfTag.php";
require_once "OWLInverseOfTag.php";
